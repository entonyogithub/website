 ...
 */
class AdminManageTeachersController extends Controller {
    ...
    public function actionIndex() {
        ...
        $search = new \backend\models\TeacherSearch();
    ...
    public function actionCreate() {
        ...
        $model = new User;
        $model->role = 'Teachers';
        $profile = new \common\models\TeacherProfile();
    ...
    protected function findModel($id) {
        if (($model = User::find()->where(['id' => $id,'role'=>'Teachers'])->notDeleted()->one()) !== null) {
            return $model;
        } else {
