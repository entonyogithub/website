...
/**
 * AdminContactRequestController implements the CRUD actions for ContactRequest model.
 */
class AdminContactRequestController extends Controller {
    ...
    public function actionIndex() {
        $dataProvider = new ActiveDataProvider([
            'query' => ContactRequest::find()->notDeleted(),
        ]);
    ...
    public function actionView($id) {
        ...
        $model->read = ContactRequest::READ_FLAG;
        $model->save();
    ...
    public function actionDelete($id) {
        $model = $this->findModel($id);
        $model->df = ContactRequest::DELETED;
        $model->save(false);
    ...
    protected function findModel($id) {
        if (($model = ContactRequest::find()->where(['id' => $id])->notDeleted()->one()) !== null) {
            return $model;
        } else {
